...
INSERT INTO `Motif`(mot_libelle) VALUES ('Visitite mensuel'),('Visite suite à un problème'),('Visite pour tests'),('Visite annuel');
...
UPDATE RapportVisite SET rap_lu = true WHERE vis_matricule LIKE "a131" AND rap_num = 1;-- MySQL dump 10.13  Distrib 5.5.62, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: gsbrv
-- ------------------------------------------------------
-- Server version	5.5.62-0+deb8u1
